...
{% hint style="info" %}
For a better user experience, you can [Flatten nested fields](https://docs.forestadmin.com/documentation/reference-guide/fields/flatten-nested-fields-mongodb)
{% endhint %}
